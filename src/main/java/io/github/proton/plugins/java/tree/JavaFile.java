...
public final class JavaFile {
    ...
    public JavaFile(JavaPackageDeclaration packageDeclaration, Vector<JavaImportDeclaration> importDeclarations, Vector<JavaClassDeclaration> classDeclarations) {
